 ...
 */
	...
	$(function(){
		...
		var data = new Array(txtEmail,txtNroId,txtNombre1,txtNombre2,txtApellido1,txtApellido2);
		
		$("#jqGrid").jqGrid({
			//url: base_url + "gh_actosadmin/gh_actosadmin/jsonQuery",
			url: generateGetURL("admin/busquedaUsuariosAJAX/", data),						
			datatype: "json",
			colModel: [
			    { label: 'Usuario (Email)', name: 'txtEmail', width: 200 },
				{ label: 'Nro. Identificaci&oacute;n', name: 'txtNroId', width: 130, sorttype: 'number' },
				{ label: 'Primer Nombre', name: 'txtNombre1', width: 130 },
				{ label: 'Segundo Nombre', name: 'txtNombre2', width: 130 },
				{ label: 'Primer Apellido', name: 'txtApellido1', width: 130 },
				{ label: 'Segundo Apellido', name: 'txtApellido2', width: 130 },				
				{ label: 'Estado Formulario', name: 'txtEstado', width: 200 },				
				{ label: 'Opciones', name: 'opc', width: 150 }								
			],
