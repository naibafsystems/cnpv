...
<div class="container">
	<div class="page-header">
		<h3>Consulta Usuario: <?php echo $usuario["usuario"]; ?></h3>
	</div>
</div>
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-4 form-group encabezadoDetalleUsuario " <?php // colores: bg-primary bg-success bg-info bg-warning bg-danger ?>
