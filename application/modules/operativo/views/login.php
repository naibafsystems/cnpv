<div class="row margin-login">
	<div class="col-md-3">
		<fieldset>
			<legend>M&oacute;dulo Verificaci&oacute;n de la Operaci&oacute;n</legend>
	...
	<div class="col-md-8">
		...
		<p><div class="alert alert-info" role="alert"><?php echo $mensaje; ?></div></p>
      	<?php } elseif (isset($enviado) && $enviado==false) { ?>
      	<p><div class="alert alert-danger" role="alert"><?php echo $mensaje; ?></div></p>
      	<?php } ?>
      	<p><div id="reslogin" class="alert alert-danger" role="alert"></div></p>
    </div>
</div>
<script src="<?php echo base_url("/js/operativo/operativo.js"); ?>"></script>
