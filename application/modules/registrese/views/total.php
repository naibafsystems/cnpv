				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="radio">
							...
							<label>
								<select class="form-control" id="txtotper" name="txtotper"  style="height: 35px; width: 80px" >
										<?php for ($i=1; $i<=20; $i++){ ?>
...
- Los residentes en las casas fiscales."/><br>
				...
				<br/>
				 <div class ="row">
					<div class="col-md-8">
						<input type=hidden id="jef" name="jef" value=""  />
						<input type=hidden id="cmpl" name="cmpl" value=""  />
				...
				<div class="row">
					<div id="result" class="form-group col-md-10">
		  			...
		  			<div id="result" class="form-group col-md-1">
		  				<button type="button" id="acepto3" name="acepto3" class="btn btn-danger">Guardar y siguiente</button>&nbsp;&nbsp;&nbsp;
