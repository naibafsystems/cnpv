	...
	*/
	function setEncoding($enc='gzip, deflate') {
		if (function_exists('gzdeflate')) {
			...
			//*** modified DMDIAZF set_magic_quotes_runtime(0);
...
//		}
	...
	function parseCookie($cookie_str) {
		...
		//Modificado **** dmdiazf $data = split(';', $cookie_str);
...
class nusoap_client extends nusoap_base  {
	...
	*/
	...
	function loadWSDL() {
		...
		wsdl('',$this->proxyhost,$this->proxyport,$this->proxyusername,$this->proxypassword,$this->timeout,$this->response_timeout,$this->curl_options,$this->use_curl);
